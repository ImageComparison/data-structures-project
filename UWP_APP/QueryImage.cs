...
namespace UWP_APP
{
    internal class QueryImage
    {
        ...
        private static List<int> Project_0DEG(List<List<byte>> data)
        {
        ...
        private static List<int> Project_45DEG(List<List<byte>> data)
        {
            List<int> result = new List<int>();
        ...
        private static List<int> Project_90DEG(List<List<byte>> data)
        {
            List<int> result = new List<int>();
            foreach (var col in Enumerable.Range(0, 28))
            {
        ...
        public static List<int> Generate_Barcode(List<byte> raw, int width, int height)
        {
            List<List<byte>> formatted_data = new List<List<byte>>();

            for (int i = 0; i < raw.Count; i+=width*4) //for each row
            {
